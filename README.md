...
Example of getTokensLeft():

truffle(develop)> sale.getTokensLeft()
BigNumber { s: 1, e: 20, c: [ 2000000 ] }

truffle(develop)> sale.buyTokens(web3.eth.accounts[1], {value : new web3.BigNumber(web3.toWei(6, 'ether')) , from : web3.eth.accounts[1]});
{ tx: '0xc90104f23ed8e01dd791280a67e79cc5b4edf732dde5bd3e68e2ecd2860da305',
  receipt: 
   { transactionHash: '0xc90104f23ed8e01dd791280a67e79cc5b4edf732dde5bd3e68e2ecd2860da305',
     transactionIndex: 0,
     blockHash: '0x24ab3f587788e1dd791c6598a598a371d872c4b8848857046a3a2943b296eddd',
     blockNumber: 9,
     gasUsed: 122575,
...
Grad Student Question: truffle(develop)> sale.buyTokens(web3.eth.accounts[1], {value : new web3.BigNumber(web3.toWei(25, 'ether')) , from : web3.eth.accounts[1]});
